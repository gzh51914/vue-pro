<template>
  <div class="cinema">
    ...
    <div class="title">
      ...
      >{{cityName}}<van-icon name="arrow-down" size=".12rem"/></div>
      <div class="center">影院</div>
      <div class="right"
      @click="handleChangePage('/cinema/search')"
      ><img src="/sousuo.png" alt></div>
    </div>
    ...
    <div class="select">
      ...
      >{{current}}<van-icon name="arrow-down" size=".12rem" />
      </div>
      <div>App订票 <van-icon name="arrow-down" size=".12rem" />
      </div>
      <div class="right">最近去过<van-icon name="arrow-down" size=".12rem" /></div>
    </div>
